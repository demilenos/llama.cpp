...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q1_0    = 41,
        GGML_TYPE_Q2_0    = 42,
        // Prism-private ternary at group size 128. Keep the GGUF type id for
        // compatibility with existing Prism PTQ1 checkpoints.
    ...
    enum ggml_ftype {
        ...
        GGML_FTYPE_MOSTLY_PTQ1_0  = 129, // Prism-private group-128 ternary
    };

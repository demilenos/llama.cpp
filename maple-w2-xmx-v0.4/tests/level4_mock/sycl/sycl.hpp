...
// serial scalar execution ONLY for Level4 host-lambda tests (WG=1). Collective
...
using std::sqrt;using std::fmin;using std::fmax;using std::fabs;using std::isfinite;using std::exp;using std::min;
struct handler {
